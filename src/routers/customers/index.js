...
// Get customer
router.get('/:storeHash/me/customers', customerAuth, (req, res) => getCustomer(req, res))
// Update customer
router.put('/:storeHash/me/customers', customerAuth, (req, res) => updateCustomer(req, res))
// Delete customer
router.delete('/:storeHash/me/customers', customerAuth, (req, res) => deleteCustomer(req, res))
