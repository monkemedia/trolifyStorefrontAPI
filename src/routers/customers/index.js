...
// Get customer
router.get('/:storeHash/me/customers', [auth, customerAuth], (req, res) => getCustomer(req, res))
// Update customer
router.put('/:storeHash/me/customers', [auth, customerAuth], (req, res) => updateCustomer(req, res))
// Delete customer
router.delete('/:storeHash/me/customers', [auth, customerAuth], (req, res) => deleteCustomer(req, res))
